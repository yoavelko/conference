                ...
                desktop ?
                    <div id='cyberpro-container'>
                        ...
                        <div className='cyberpro-containers'>
                            ...
                            <div>תוכנית מטעם צה"ל בשיתוף עמותת עתידים, מנהלת שער לעתיד, האגף והקרן לחיים משוחררים וארגון Start-Up Nation Central מיועדת ללוחמים/ות לקראת שחרור או משוחררים עד חמש שנים מיום השחרור. התוכנית מעניקה הכשרות מגוונות במתכונת BOOTCAMP ברמה הגבוהה ביותר במגוון מקצועות בתחום ההייטק, ובשיתוף פעולה מלא עם תעשיית ההייטק בישראל. הלימודים הינם אינטנסיביים ובמשך כל ימות השבוע, א'-ה' בין השעות 9:00-17:00</div>
