  ...
  return (
    <div className="invationSummary-container">
      ...
      <div className="more-info-about-the-conference">
        תוכנית ״לוחמים להייטק״ בהובלת עמותת ידידי עתידים ובתמיכתה של צמרת צה"ל,
        הינה תוכנית ייחודית שהוקמה כחלק מהמאמץ הלאומי לשילוב לוחמים ולוחמות בענף
        ההייטק. במסגרת התוכנית אנו מכשירים את יוצאי ויוצאות המערך הלוחם בצה"ל
        לתחומי פיתוח, אבטחת מידע וסייבר.
      </div>
