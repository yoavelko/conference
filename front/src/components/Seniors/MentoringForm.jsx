  ...
  return (
    <div className="mentoring-form-container">
      <div ref={mentors} className="mentoring-details">
        ...
        <div>
          תוכנית המנטורים הייחודית של סייברפרו ישראל מאפשרת למעסיקים רבים לקחת
          חלק פעיל בקידום יוצאי ויוצאות המערך הלוחם בעולם ההייטק. במסגרת התוכנית
          תוכלו לתרום למאות לוחמים ולוחמות באמצעות הידע והניסיון האישי שלכם
          בתעשייה.
        </div>
        <br />
        <div>
          <div>ישנן מגוון דרכים להשתלב בקהילת המנטורים שלנו, לדוגמא:</div>
          <ul className="dots-for-mentors">
            <li>חניכה אישית של לוחמים ולוחמות.</li>
            <li>העברת סדנאות בתחומי המיומנויות הרכות.</li>
            <li>
              אירוח הלוחמים והלוחמות בחברות עסקיות תוך הדמיה של סביבת העבודה.
            </li>
            <li>השתתפות בהאקתון על ידי שיפוט בתחרות, ליווי מקצועי והכנה לפרזנטציה.</li>
          </ul>
        </div>
      </div>
      <br />
      <div id="mentoring-container">
        <h2 className="mentoring-form-title">
          רוצים לקחת חלק בקהילת המנטורינג?
        </h2>
          ...
          <div id="whatsapp-mentor">
            ...
            >
              <div id="whatsapp-mentor-container">
                ...
                ></img>
                <div className="mentoring-text">&nbsp; דברו איתנו</div>
              </div>
            </a>
          </div>
          <div id="whatsapp-mentor">
            <div id="mail-mentor-container">
              ...
              <a
                ...
                rel="noopener noreferrer"
              >
                <div className="mentoring-text">&nbsp; כתבו לנו</div>
              </a>
            </div>
          </div>
        </div>
